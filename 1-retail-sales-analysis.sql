...
CREATE DATABASE sql_retail_sales_analysis_p2;
...
--Q.2: Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is 4 or more than 4 in the month of Nov-2022.
SELECT *
FROM retail_sales
WHERE 
	category = 'Clothing'
...
SELECT 
	category, --',' to distinguish 2 columns
	SUM(total_sale) as net_sale,
	COUNT(*) as total_orders
FROM retail_sales
GROUP BY 1 -- 1 is the first column name appearing after SELECT
